...
//                    )
                    ...
                    StudentCodeTextField(Modifier.padding(innerPadding))
                }
            }
        }
    }
...
fun StudentCodeTextField(modifier: Modifier){
    ...
    Column(modifier = modifier.fillMaxSize().wrapContentWidth(Alignment.CenterHorizontally).wrapContentHeight(Alignment.CenterVertically)){
